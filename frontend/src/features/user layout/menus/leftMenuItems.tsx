	...
	return [
		{
			label: (
				<Flex vertical align="center" justify="center" gap={10}>
					...
					{splitterSize[0] as number > 220 && <Title level={4}>{i18next.t("Home")}</Title>}
				</Flex>
			),
			key: "home",
		...
		},
		{
			label: (
				<Flex vertical align="center" justify="center" gap={10}>
					...
					{splitterSize[0] as number > 220 && <Title level={4}>{i18next.t("Explore")}</Title>}
				</Flex>
			),
			key: "explore",
			style: { height: "auto", padding:11 },
		...
		},
		{
			label: (
				<Flex vertical align="center" justify="center" gap={10}>
					...
					{splitterSize[0] as number > 220 && <Title level={4}>{i18next.t("Upcoming Journeys")}</Title>}
				</Flex>
			),
			key: "upcoming",
			style: { height: "auto", padding:11 },
		...
		},
		{
			label: (
				<Flex vertical align="center" justify="center" gap={10}>
					...
					{splitterSize[0] as number > 220 && <Title level={4}>{i18next.t("Completed Journeys")}</Title>}
				</Flex>
			),
			key: "completed",
			style: { height: "auto", padding:11 },
		...
		{
			label: (
				<Flex vertical align="center" justify="center" gap={11}>
					{selectedLeftMenuItem === "deleted" ? (
						<DeleteRoundedIcon style={{ fontSize: 35 }} />
					) : (
						<DeleteOutlineRoundedIcon style={{ fontSize: 35 }} />
					)}
					{splitterSize[0] as number > 220 && <Title level={4} >{i18next.t("Deleted Journeys")}</Title>}
				</Flex>
			),
			key: "deleted",
			style: { height: "auto", padding:11},
