		...
		<>
			...
			>
				<Flex vertical align="center">
					...
					<Text
						style={{ fontSize: 20, padding: "0px 30px", textAlign: "center" }}
					>
						Get full access to the premium features you need, from just{" "}
						<Text
							style={{
						...
						a day. Try it for free.
					</Text>
					<br />
					<Segmented
						options={["Monthly", "Annually"] as ("Annually" | "Monthly")[]}
						size="large"
						value={type}
					...
					<Row
						gutter={[32, 32]}
						style={{ width: breakpoints.largerThan("lg") ? "auto" : "100%" }}
					>
						{type === "Annually" ? (
							<>
								<Col
								...
								>
									<Card
										style={{
											width: breakpoints.largerThan("lg") ? 450 : "90%",
											height: 450,
									...
									>
										...
										>
											<Flex justify="space-between" align="top">
												<Flex align="center" gap={15} style={{ height: 40 }}>
													<Title level={2} style={{ margin: 0 }}>
														Pro
													</Title>
													<Tag color="success">Save 40%</Tag>
												</Flex>
												<Flex vertical align="end">
													...
													<Text style={{ fontSize: 15 }}>Billed Annually</Text>
												</Flex>
											</Flex>

											<Flex flex={1} style={{ marginTop: 15 }}>
												<List
													dataSource={[
														{
										...
										>
											<Flex justify="space-between" align="top">
												...
												<Flex vertical align="end">
													...
													<Text style={{ fontSize: 15 }}>Billed Monthly</Text>
												</Flex>
											</Flex>
											<Flex flex={1} style={{ marginTop: 15 }}>
												<List
